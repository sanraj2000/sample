...
private SearchUtil() {}
    ...
    public static SearchRequest buildSearchRequest(final String indexName,
        ...
        try {
            final SearchSourceBuilder builder = new SearchSourceBuilder()
                    .postFilter(getQueryBuilder(field, author));
	...
	private static QueryBuilder getQueryBuilder(final SearchRequestDTO dto) {
	 ...
	 private static QueryBuilder getQueryBuilder(final String field,final String author) {
		 return QueryBuilders.matchQuery(field, author);
	 }


	public static SearchRequest buildSearchRequest(String bookIndex) {
		// TODO Auto-generated method stub
		//return null;
		SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
        searchSourceBuilder.query(QueryBuilders.matchAllQuery());
        final SearchRequest request = new SearchRequest(bookIndex);
